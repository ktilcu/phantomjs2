...
&&  mkdir phantomjs \
&&  cd phantomjs \
&&  wget https://github.com/ariya/phantomjs/archive/2.0.zip \
&&  unzip 2.0.zip \
&&  rm -rf /phantomjs/2.0.zip \
    # Building phantom
&&  cd phantomjs-2.0/ \
...
&&  ln -s /phantomjs/phantomjs-2.0/bin/phantomjs /usr/local/share/phantomjs \
&&  ln -s /phantomjs/phantomjs-2.0/bin/phantomjs /usr/local/bin/phantomjs \
&&  ln -s /phantomjs/phantomjs-2.0/bin/phantomjs /usr/bin/phantomjs \
...
CMD \
    echo "phantomjs binary is located at /phantomjs/phantomjs-2.0/bin/phantomjs"\
